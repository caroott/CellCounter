...
let project = "CellCounter"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "An application to automatically count cells using wavelet transformation"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "An application to automatically count cells using wavelet transformation"

// List of author names (for NuGet package)
let author = "Jonathan Ott"

// Tags for your project (for NuGet package)
let tags = "Biology Bioinformatics Cells Counter"

// File system information
let solutionFile  = "CellCounter.sln"
...
let gitName = "CellCounter"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/Joott"

let website = "/CellCounter"
...
let info =
  [ "project-name", "CellCounter"
    "project-author", "Jonathan Ott"
    "project-summary", "An application to automatically count cells using wavelet transformation"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/CellCounter" ]
